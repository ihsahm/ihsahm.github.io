    ...
    <div className="App">
      ...
      <FadeInSection>
        <section className="about">
          <h3>About Me</h3>
          <p
            style={{ fontSize: "1.1rem", lineHeight: "1.8", color: "#4a5568" }}
          >
            Hi! I'm Ihsan, a passionate mobile app developer specializing in
            Flutter. I graduated with a Bachelor's degree in Computer Science
            from HiLCoE School of Computer Science and Technology. I enjoy
            building beautiful, high-performance mobile applications and helping
            you solve business oriented problems.
          </p>
        </section>
      </FadeInSection>
          ...
          <div className="projects-grid">
            ...
            >
              ...
              <p>
                ...
                investment.Connect with agents, brokers, and builders in
                Ethiopia.
              </p>
            </div>
            <div
            ...
            >
              ...
              <h4>E-Chereta</h4>
              <p>
                E-Chereta enables users to access private and governmental
                tenders within the country through a subscription based model.
                They also can buy and download bid documents online.
              </p>
            </div>
            <div
              className="project-card"
            ...
            >
              ...
              <h4>Poolmate</h4>
              <p>
                PoolMate is a Car-pooling Android application that allows users
                to share a ride and costs. The app connects riders with drivers,
            ...
            >
              <div className="project-image">
                <img
                  src="/images/gizze.jpg"
                  alt="Sand Delivery App Screenshot"
                />
              </div>
              <h4>Gizze</h4>
              <p>
                Gizze is a sand delivery app that connects construction
                management workers and owners that seek to buy sand, granite and
                gravel with respective sellers/drivers.
              </p>
            </div>
          </div>
        </section>
